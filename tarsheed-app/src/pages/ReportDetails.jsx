...
export default function ReportDetails() {
  ...
  return (
    <div className={styles.container}>
      {report.imageFile && (
        <img src={report.imageFile} alt="Report" className={styles.image} />
      )}
      <h2 className={styles.title}>{report.title}</h2>
      <h3 className={styles.reporterName}>{report.reporterName}</h3>
      <h3 className={styles.reporterPhone}>{report.reporterPhone}</h3>
