...
export default function AddReport() {
  ...
  const [state, setState] = useState("KH");
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!imageFile) {
      toast.error("يرجى التقاط صورة قبل إرسال البلاغ");
      return;
    }
    setSubmitting(true);
    try {
  ...
  return (
    <div className={styles.addReport} dir="ltr">
      ...
      <div className={styles.pictureSection}>
        {image && !approved ? (
          <>
            <img src={image} alt="Report" className={styles.previewImg} />
            <div>
              <button
      ...
      <AnimatePresence>
        {approved && (
          ...
          >
            ...
            <label className={styles.label}>
              <span>
                اسم المبلغ <span className={styles.required}>*</span>
              </span>
              <input
                type="text"
            ...
            <label className={styles.label}>
              <span>
                رقم هاتف المبلغ <span className={styles.required}>*</span>
              </span>
              <input
                type="tel"
